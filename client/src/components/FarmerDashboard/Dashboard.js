...
// import { Menu, Sun, CloudRain, Wind, Thermometer, Crop, Users, BarChart2, Calendar, HelpCircle, LogOut, Globe, Farm } from 'lucide-react';
...
//                     </div>
//                     {[
//                         { icon: <BarChart2 className="w-5 h-5 mr-3" />, text: "Live status Dashboard" },
...
//                         { icon: <Calendar className="w-5 h-5 mr-3" />, text: "Agri Calendar" },
...
//                         { icon: <Farm className="w-5 h-5 mr-3" />, text: "About" }
//                     ].map((item, index) => (
//                         <div key={index} className="flex items-center py-2 px-4 hover:bg-green-700 cursor-pointer">
//                             {item.icon}
//                             <span>{item.text}</span>
//                         </div>
//                     ))}

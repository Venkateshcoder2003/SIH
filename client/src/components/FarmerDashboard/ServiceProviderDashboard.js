...
//     const [newService, setNewService] = useState({ name: '', charge: '', availability: '' });
...
//         setNewService({ name: '', charge: '', availability: '' });
//         // Update farmer dashboard
//         updateFarmerDashboard(updatedServices);
//     };
//     const [activeContracts] = useState([
//         { id: 1, farm: 'Farm X', service: 'Equipment Rental', duration: '1 month' },
//         { id: 2, farm: 'Farm Y', service: 'Pest Control', duration: '2 weeks' },
...
//                     required
//                 />
//                 <button type="submit" className="bg-green-500 text-white p-2 rounded">Add Service</button>
//             </form>
//             <ul>
//                 {services.map((service) => (
//                     <li key={service.id} className="mb-2">
//                         {service.name} - ₹{service.charge} - {service.availability}
//                     </li>
//                 ))}
//             </ul>
//         </div>
...
//                         {request.farmerName} requested {request.serviceName} on {request.date}
//                     </li>
//                 ))}
//             </ul>
//         </div>
...
//                 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
//                     {currentPage === 'services' && renderServices()}
//                     {currentPage === 'requests' && renderServiceRequests()}
//                     {/* ... other sections ... */}
//                 </div>
//             </main>
//             {/* Main content */}
